...
class MaterialUniform(Base):
    ...
    oid = Column(Integer, primary_key=True,unique=True)
    ...
    def keys(self):
        return ["Code", "MaterialDrawing", "uniformitem", "Name", "EnglishName", "Unit", "FirstClass", "vector", "status"]

    def __getitem__(self, item):
        return self.__getattribute__(item)

    def __init__(self, Code, MaterialDrawing, uniformitem, EnglishName, Name, Unit, FirstClass, vector, status):
        self.Code = Code
